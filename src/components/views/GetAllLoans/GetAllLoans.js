    ...
    <Container maxWidth='lg' disableGutters={false}>
      ...
      <Paper>
        ...
        {displayState === 2 ? 
          ...
          {displayState === 3 ? 
            <>
              <h3>Showing loan ID #${selectedLoanDetails.loan_id}'s payment schedule. {selectedLoanDetails.self_owned ? `This loan is owned by ${selectedLoanDetails.self_owned}.` : ``}</h3>
